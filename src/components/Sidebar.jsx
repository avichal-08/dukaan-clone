    ...
    return(
        <div style={{backgroundColor:"#131f38"}} className="h-screen w-56 fixed">
            <div className="flex pt-5 pl-5">
                <div className="bg-white h-11 w-11 text-sm pt-[10px] pl-[4px]">𝓐𝓿𝓲</div>
            ...
            <Options/>
            <div className="flex bg-gray-700 w-46 h-15 mt-25 ml-4">
                <div className="text-white bg-gray-600 w-10 m-3 p-1"><CiWallet size={30}/></div>
