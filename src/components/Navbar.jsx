...
export function Navbar(){
    return(
        <div className="flex p-4 bg-white border border-b-gray-300 h-17">
            ...
            <div className="flex bg-gray-200 w-85 ml-48 h-10 mt-0 "><span className="py-3 w-8 pl-3 pr-1 text-gray-600" ><CiSearch size={18}/></span><input className="pl-2 w-77" type="text" placeholder="Search features,tutorials,etc"/></div>
